...
Una agencia mediocre elige una de las tres y sacrifica las otras dos. El SEO puro produce contenido denso en keywords que no convierte porque olvida al lector. El copywriting publicitario tradicional produce texto persuasivo que no rankea porque olvida la arquitectura semántica. El "content marketing" genérico produce texto bonito que no responde la intención específica de búsqueda y por eso no rankea ni convierte.
...
**Frameworks que funcionan mejor:** PAS (Problema-Agitación-Solución) con agitación educativa, no emocional-manipulativa. Before-After-Bridge mostrando el camino realista. Jobs to be Done para mapear qué está intentando lograr el usuario ("quiero comprar casa", "quiero salir de deudas").
...
**Intenciones de búsqueda típicas:** "mejor [producto] para [uso]", "[producto] review honesto", "[marca] vale la pena", "como elegir [producto]", "[producto] comparativa".

**Tono recomendado:** cercano-entusiasta-específico. Storytelling corto ("por qué creamos este producto") + utilidad práctica ("cómo usarlo"). Evitar corporate-speak; abrazar voz de marca humana.

**Frameworks que funcionan mejor:** StoryBrand (Donald Miller), Picture-Promise-Proof-Push (4 Ps Copy), social proof intenso con UGC.
...
**Frameworks que funcionan mejor:** PAS con problema educativo ("estás a punto de cometer uno de los errores más comunes en primera compra"); comparación de zonas con data real; guías paso a paso por fase (búsqueda, oferta, cierre, mudanza).
...
**Intenciones de búsqueda típicas:** "mejor [tipo cocina] en [ciudad/zona]", "brunch cerca de mi", "restaurante para aniversario [ciudad]", "[restaurante] menu", "[restaurante] reservation".

**Tono recomendado:** sensorial-cercano-evocador. El copy de F&B gana con descripciones sensoriales (olor, textura, temperatura) y pierde con adjetivos genéricos ("delicioso", "espectacular"). Historia del chef/local cuando hay autenticidad.

**Frameworks que funcionan mejor:** Sensory copy (ingredientes, método, origen); storytelling de chef/local; listicles de "mejores X en Y"; CTAs de reserva/pedido directo.
...
**Intenciones de búsqueda típicas:** "mejor escuela primaria [ciudad]", "método [Montessori/Waldorf/etc]", "academia [materia] [ciudad]", "que hacer si mi hijo no [habilidad]", "desarrollo [edad años]".

**Tono recomendado:** profesional-empático-claro. Evidencia pedagógica real (no "estudios muestran" genéricos — citar los estudios). Respeto absoluto por el dilema del padre/madre; evitar fear-mongering sobre retrasos del desarrollo.

**Frameworks que funcionan mejor:** PAS con problema real del desarrollo; educación con fuentes pedagógicas citadas; case studies con nombres y fotos (con permiso); FAQs muy detalladas.
...
**Intenciones de búsqueda típicas:** "limpia espiritual [ciudad]", "chamán [tipo] [región]", "significado de [símbolo/sueño]", "ritual para [objetivo]", "lectura de [tipo de oráculo]".

**Tono recomendado:** respetuoso-autoritario-cultural. El vocabulario importa — usar términos correctos de la tradición (no mezclar tradiciones). Evitar lenguaje "new age" genérico. La autoridad viene de linaje, práctica, lugar.

**Frameworks que funcionan mejor:** storytelling de tradición + educación sobre la práctica + testimonios de la comunidad (con respeto); FAQs culturales muy detalladas.
...
**Intenciones de búsqueda típicas:** "plomero emergencia [ciudad]", "electricista 24 horas [zona]", "cerrajero cerca de mi", "reparación [aparato] [ciudad]", "tarifas [servicio]".

**Tono recomendado:** profesional-directo-confiable. Zero florituras; máxima especificidad operativa (tiempo de respuesta, cobertura, garantía, precios transparentes). Los buscadores de servicios locales premian la velocidad del mensaje.

**Frameworks que funcionan mejor:** PAS con urgencia real del problema; social proof extremo (reviews con nombre, fotos antes/después); CTA directo al teléfono/WhatsApp.
