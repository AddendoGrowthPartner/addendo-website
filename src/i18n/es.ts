const es = {
  ...
  hero: {
    ...
    title1: 'Crecimiento de ventas ',
    titleGold: 'predecible, automatizado e imparable.',
    title2: '',
    subtitle: 'Combinamos estrategia, tecnología e inteligencia artificial para transformar tu negocio en una máquina de ventas que trabaja 24/7.',
