...
import { FiSearch, FiTarget, FiZap, FiTrendingUp } from 'react-icons/fi';
import type { IconType } from 'react-icons';

const icons: IconType[] = [FiSearch, FiTarget, FiZap, FiTrendingUp];
  ...
  return (
    <section id="como-funciona" className="section-pad" style={{ background: '#080F24' }}>
      <div className="max-w-7xl mx-auto">
        ...
        {t.howItWorks.subtitle && <p className="text-white/40 text-base sm:text-lg text-center max-w-2xl mx-auto mb-10">{t.howItWorks.subtitle}</p>}
