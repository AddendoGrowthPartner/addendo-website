  ...
  return (
    <section ref={ref} id="contacto" className="section-pad relative" style={{ background: '#0A1228' }}>
      <div className="relative max-w-2xl mx-auto">
        <h2 className="ct-a opacity-0 font-display text-3xl sm:text-4xl md:text-5xl font-semibold text-center mb-4"><span className="gold-gradient-text">{t.contact.title}</span></h2>
