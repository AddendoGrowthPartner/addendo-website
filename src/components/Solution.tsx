    ...
    <section ref={ref} className="section-pad relative overflow-hidden" style={{ background: '#080F24' }}>
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div>
            <h2 className="s-a opacity-0 font-display text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">{t.solution.title1}<br /><span className="gold-gradient-text">{t.solution.titleGold}</span></h2>
