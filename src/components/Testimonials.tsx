...
const imgs = [
  ...
  'https://images.pexels.com/photos/1181292/pexels-photo-1181292.jpeg?auto=compress&cs=tinysrgb&w=150',
  'https://images.pexels.com/photos/5920775/pexels-photo-5920775.jpeg?auto=compress&cs=tinysrgb&w=150',
];
    ...
    <section ref={ref} className="section-pad relative" style={{ background: '#0A1228' }}>
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="te-t opacity-0 text-center mb-14">
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-4">{t.testimonials.title1}<span className="gold-gradient-text">{t.testimonials.titleGold}</span></h2>
        </div>
