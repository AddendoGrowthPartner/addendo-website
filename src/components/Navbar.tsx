      ...
      <div className="flex items-center justify-between h-16 px-6 md:px-10 max-w-7xl mx-auto">
        <a href="/" className="flex items-center gap-4 shrink-0">
          ...
          <div className="flex flex-col leading-none">
            <span style={{ fontFamily: 'Fraunces, serif', fontSize: '22px', fontWeight: '400', color: '#C9A84C', letterSpacing: '0.14em' }}>ADDENDO</span>
            <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '10px', fontWeight: '300', color: 'rgba(255,255,255,0.5)', letterSpacing: '0.22em' }}>GROWTH PARTNER</span>
          </div>
        </a>
