  ...
  return (
    <section ref={ref} id="proceso" className="section-pad relative" style={{ background: '#0A1228' }}>
      <div className="max-w-5xl mx-auto">
        <h2 className="pr-t opacity-0 font-display text-3xl sm:text-4xl md:text-5xl font-semibold text-center mb-20">{t.process.title1}<br /><span className="gold-gradient-text">{t.process.titleGold}</span></h2>
