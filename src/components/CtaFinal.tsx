  ...
  return (
    <section ref={ref} className="section-pad relative overflow-hidden" style={{ background: '#080F24' }}>
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <h2 className="cta-a opacity-0 font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">{t.cta.title1}<br /><span className="gold-gradient-text">{t.cta.titleGold}</span></h2>
