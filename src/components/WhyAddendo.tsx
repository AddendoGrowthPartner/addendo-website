  ...
  return (
    <section ref={ref} id="por-que" className="section-pad relative" style={{ background: '#080F24' }}>
      ...
      <div className="relative max-w-6xl mx-auto">
        <h2 className="w-t opacity-0 font-display text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-16">{t.why.title1}<br /><span className="gold-gradient-text">{t.why.titleGold}</span></h2>
