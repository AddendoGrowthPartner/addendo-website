...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: '#080F24' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full pt-44 sm:pt-48 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h1 className="hero-h1 font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[1.05] mb-6 md:mb-8">
              {t.hero.title1}
